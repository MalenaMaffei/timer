...
def setup(stdscr):
    ...
    curses.init_pair(4, -1, curses.COLOR_MAGENTA)
    ...
    try:
        while seconds_left > 0 or blink or text:
                ...
                with curses_lock:
                    ...
                    try:
                        draw_text(
                            ...
                            color=COLOR_ALARM if seconds_left <= critical else COLOR_DEFAULT,
            ...
            if seconds_left <= 0:
                ...
                if blink or text:
                    base_color = COLOR_ALARM if blink else COLOR_DEFAULT
                    blink_reset = False
                    flip = True
                    slept = 0
                    extra_sleep = 0
